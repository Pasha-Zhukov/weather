...
export const GlobalSvgSelector = (props) => {
    switch (props.id) {
        case '01d':
            return (
                <img src="http://openweathermap.org/img/wn/01d@2x.png" alt="" width="130px" height="130px" />
            );
        case '02d':
            return (
                <img src="http://openweathermap.org/img/wn/02d@2x.png" alt="" width="130px" height="130px" />
            );
        case '03d':
            return (
                <img src="http://openweathermap.org/img/wn/03d@2x.png" alt="" width="130px" height="130px" />
            );
        case '04d':
            return (
                <img src="http://openweathermap.org/img/wn/04d@2x.png" alt="" width="130px" height="130px" />
            );
        case '09d':
            return (
                <img src="http://openweathermap.org/img/wn/09d@2x.png" alt="" width="130px" height="130px" />
            );
        case '10d':
            return (
                <img src="http://openweathermap.org/img/wn/10d@2x.png" alt="" width="130px" height="130px" />
            );
        case '11d':
            return (
                <img src="http://openweathermap.org/img/wn/11d@2x.png" alt="" width="130px" height="130px" />
            );
        case '13d':
            return (
                <img src="http://openweathermap.org/img/wn/13d@2x.png" alt="" width="130px" height="130px" />
            );
        case '50d':
            return (
                <img src="http://openweathermap.org/img/wn/50d@2x.png" alt="" width="130px" height="130px" />
            );
        case '01n':
            return (
                <img src="http://openweathermap.org/img/wn/01n@2x.png" alt="" width="130px" height="130px" />
            );
        case '02n':
            return (
                <img src="http://openweathermap.org/img/wn/02n@2x.png" alt="" width="130px" height="130px" />
            );
        case '03n':
            return (
                <img src="http://openweathermap.org/img/wn/03n@2x.png" alt="" width="130px" height="130px" />
            );
        case '04n':
            return (
                <img src="http://openweathermap.org/img/wn/04n@2x.png" alt="" width="130px" height="130px" />
            );
        case '09n':
            return (
                <img src="http://openweathermap.org/img/wn/09n@2x.png" alt="" width="130px" height="130px" />
            );
        case '10n':
            return (
                <img src="http://openweathermap.org/img/wn/10n@2x.png" alt="" width="130px" height="130px" />
            );
        case '11n':
            return (
                <img src="http://openweathermap.org/img/wn/11n@2x.png" alt="" width="130px" height="130px" />
            );
        case '13n':
            return (
                <img src="http://openweathermap.org/img/wn/13n@2x.png" alt="" width="130px" height="130px" />
            );
        case '50n':
            return (
                <img src="http://openweathermap.org/img/wn/50n@2x.png" alt="" width="130px" height="130px" />
            );
        case 'header-logo':
            return (
                <svg
